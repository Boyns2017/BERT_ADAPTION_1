...
choose_belief_2 = ["human_waits", "human_notices"]
choose_belief_3 = ["robot_notices", "robot_does_not_notice"]
choose_belief_4 = ["far", "close"]
choose_belief_5 = ["indecisive", "decisive"]
j = 0
random.seed(300)
