...
if os.path.isfile('/home/nm/catkin_ws/covhtml/src_table_simulator_scripts_robot_py.html'):
    for i, line in enumerate(open('/home/nm/catkin_ws/covhtml/src_table_simulator_scripts_robot_py.html', 'r')):
    ...
    #Print error message:
    errmsg = 'Error: could not open file: '+ os.getcwd()+'/home/nm/catkin_ws/covhtml/src_table_simulator_scripts_robot_py.html' + '\n'
    print errmsg
